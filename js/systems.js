...
//   atmosphere    = atmosphere top altitude, metres (drag + heating below this)
//   rho0          = sea-level atmospheric density, kg/m^3 (see js/aero.js)
...
SG.Systems = {
  default: [
    { name: "Sun",     parent: null,     radius: 6.9634e8, mu: 1.32712440018e20, color: "#ffc234", atmosphere: 2.0e8, rho0: 0 },

    { name: "Mercury", parent: "Sun",    radius: 2.4397e6, mu: 2.2032e13,  color: "#9c8b7d", atmosphere: 0,
      orbitRadius: 5.791e10,  phase: 0.3 },
    { name: "Venus",   parent: "Sun",    radius: 6.0518e6, mu: 3.24859e14, color: "#c9a969", atmosphere: 2.5e5, rho0: 65,
      orbitRadius: 1.0821e11, phase: 1.9 },

    { name: "Earth",   parent: "Sun",    radius: 6.371e6,  mu: 3.986004418e14, color: "#3d6fb0", atmosphere: 1.4e5, rho0: 1.225,
    ...
    { name: "Mars",    parent: "Sun",    radius: 3.3895e6, mu: 4.282837e13, color: "#c1552f", atmosphere: 6.0e4, rho0: 0.02,
    ...
    { name: "Jupiter", parent: "Sun",    radius: 6.9911e7, mu: 1.26686534e17, color: "#c8a06a", atmosphere: 6.0e6, rho0: 0.3,
    ...
    { name: "Saturn",  parent: "Sun",    radius: 5.8232e7, mu: 3.7931187e16, color: "#d8c288", atmosphere: 5.0e6, rho0: 0.2,
      orbitRadius: 1.4335e12, phase: 2.1 },
    { name: "Titan",   parent: "Saturn", radius: 2.5747e6, mu: 8.978e12,    color: "#c9973f", atmosphere: 4.0e5, rho0: 5.4,
      orbitRadius: 1.2219e9,  phase: 0.9 },

    { name: "Uranus",  parent: "Sun",    radius: 2.5362e7, mu: 5.793939e15, color: "#a9d6e0", atmosphere: 3.0e6, rho0: 0.2,
      orbitRadius: 2.8725e12, phase: 4.6 },
    { name: "Neptune", parent: "Sun",    radius: 2.4622e7, mu: 6.836529e15, color: "#3a5fc8", atmosphere: 3.0e6, rho0: 0.25,
